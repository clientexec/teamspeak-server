        ...
        */
        ...
        $variables = array (
                   ...
                   /*T*/"Description"/*/T*/ => array (
                                        ...
                                        "value"         => /*T*/"Teamspeak voice server integration.  Note: The custom field settings are used to hold information about the clients server.  Please create these fields in admin->custom fields->packages first.  The package name on server fields for each package hold the slot count.  Suspending a server sets the slot count to 0."/*/T*/
                                       ),
                   /*T*/"Username"/*/T*/ => array (
                                        "type"          => "text",
                   ...
                   /*T*/"Client Username Custom Field"/*/T*/ => array(
                                        "type"          => "text",
                                        "description"   => /*T*/"Enter the name of the package custom field that will hold the client teamspeak admin username."/*/T*/,
                                        "value"         => ""
                                        ),
                   /*T*/"Client Password Custom Field"/*/T*/ => array(
                                        "type"          => "text",
                                        "description"   => /*T*/"Enter the name of the package custom field that will hold the client teamspeak admin password"/*/T*/,
                                        "value"         => ""
                                        ),
                   /*T*/"Actions"/*/T*/ => array (
                                        "type"          => "hidden",
